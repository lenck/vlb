function well = ellipse_warp(H, ell, varargin)
% ELLIPSE_WARP Warp elliptical frame through homography
%   WELL = ELLIPSE_WARP(H, ELL) warps the ellptical frame(s) ELL by
...
% Copyright (C) 2011-16 Andrea Vedaldi, Kristina Mikolajczyk
% All rights reserved.
%
