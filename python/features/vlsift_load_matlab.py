...
class vlsift_load_matlab(DetectorAndDescriptor):
    def __init__(self, peak_thresh = 3.0, Magnif = 5.0, csv_flag = True):
        super(vlsift_load_matlab,self).__init__(name = 'vlsift_load_matlab', is_detector = True, is_descriptor = True, is_both = True, csv_flag = csv_flag)
    ...
    def detect_feature(self, image):
        ...
        image = image/255.0
        feature, descriptor = eng.vl_sift(matlab.single(image.tolist()), 'Magnif', self.Magnif, nargout = 2)#, peak_thresh=self.peak_thresh
